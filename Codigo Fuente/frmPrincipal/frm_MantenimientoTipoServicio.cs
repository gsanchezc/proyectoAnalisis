...
{
    public partial class frm_MantenimientoTipoServicio : Form
    {
        ...
        public frm_MantenimientoTipoServicio()
        {
            InitializeComponent();
        }

        public frm_MantenimientoTipoServicio(string usuario)
            : this()
        {
            this.usuarioSistema = usuario;
        }

        private void frm_MantenimientoTipoServicio_Load(object sender, EventArgs e)
        {
            this.cargar_ListaTipoServicio();
            this.limiteCampos();
        }

        private void frm_MantenimientoTipoServicio_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        public void insertarTipoServicio()
        {
            ...
            objTipoServicio.descripcion = txt_descripcion.Text;
            objTipoServicio.isDeleted = false;

            string accion = String.Empty;
            accion = "Insertar";

            if (objTipoServicio.agregarActualizarTipoServicio(accion))
            {
        ...
        public void updateTipoServicio()
        {
            ...
            objTipoServicio.idTipoServicio = Id;
            objTipoServicio.descripcion = txt_descripcion.Text;
            objTipoServicio.isDeleted = false;
        ...
        {
            objTipoServicio.idTipoServicio = Id;
            if (objTipoServicio.eliminarTipoServicio())
            {
        ...
        //METODO
        //RAFAEL ANGEL SEQUEIRA VARGAS
        private void cargar_ListaTipoServicio()
        {
            try
            {
                dtg_tipoServicios.AutoGenerateColumns = false;
                dtg_tipoServicios.DataSource = objTipoServicio.cargaListaTipoPuesto().Tables[0];
            }
            catch (Exception)
            {
