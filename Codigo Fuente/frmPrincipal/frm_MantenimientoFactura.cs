...
{
    public partial class frm_MantenimientoFactura : Form
    {
        ...
        public frm_MantenimientoFactura()
        {
            InitializeComponent();
        }

        public frm_MantenimientoFactura(string usuario)
            : this()
        {
            this.usuarioSistema = usuario;
        }

        private void frm_MantenimientoFactura_Load(object sender, EventArgs e)
        {

        }

        private void frm_MantenimientoFactura_FormClosing(object sender, FormClosingEventArgs e)
        {
