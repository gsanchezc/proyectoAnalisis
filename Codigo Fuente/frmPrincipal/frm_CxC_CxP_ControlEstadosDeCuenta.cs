...
{
    public partial class frm_CxC_CxP_ControlEstadosDeCuenta : Form
    {
        ...
        public frm_CxC_CxP_ControlEstadosDeCuenta()
        {
            InitializeComponent();
        }

        public frm_CxC_CxP_ControlEstadosDeCuenta(string usuario) : this()
        {
            this.usuarioSistema = usuario;
        }

        private void frm_CxC_CxP_ControlEstadosDeCuenta_Load(object sender, EventArgs e)
        {
        ...
        private void frm_CxC_CxP_ControlEstadosDeCuenta_FormClosing(object sender, FormClosingEventArgs e)
        {
