...
namespace Clases
{
    public class ClienteProveedor
    {
        ...
        #region Metodos
        public DataSet cargarClienteProveedor()
        {
            ...
            {
                sql = "stp_traeTipoClienteProveedor";
        ...
        public bool agregarActualiazarClienteProveedor(string accion)
        {
            conexion = cls_DAL.trae_conexion("Soportic", ref mensaje_error, ref numero_error);
            if (conexion == null)
            {
            ...
            else
            {
                ...
                {
                    sql = "stp_insertarTipoClienteProveedor";
                }
                else
                {
                    sql = "stp_modificarTipoClienteProveedor";
                }
        ...
        public bool eliminarClienteProveedor()
        {
            ...
            {
                sql = "stp_borrarTipoClienteProveedor"; 
